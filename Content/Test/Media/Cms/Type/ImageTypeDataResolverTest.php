...
class ImageTypeDataResolverTest extends TestCase
{
    ...
    public function testEnrichWithUrlOnly(): void
    {
        ...
        $fieldConfig = new FieldConfigCollection();
        $fieldConfig->add(new FieldConfig('url', FieldConfig::SOURCE_STATIC, 'http://snapadmin.net/image.jpg'));

        $slot = new CmsSlotEntity();
        $slot->setUniqueIdentifier('id');
        $slot->setType('image');
        $slot->setConfig(['url' => 'http://snapadmin.net/image.jpg']);
        $slot->setFieldConfig($fieldConfig);
        ...
        $imageStruct = $slot->getData();
        static::assertInstanceOf(ImageStruct::class, $imageStruct);
        static::assertSame('http://snapadmin.net/image.jpg', $imageStruct->getUrl());
        static::assertEmpty($imageStruct->getMedia());
        static::assertEmpty($imageStruct->getMediaId());
    }
    ...
    public function testEnrichWithMediaAndUrl(): void
    {
        ...
        $slot->setUniqueIdentifier('id');
        $slot->setType('image');
        $slot->setConfig(['mediaId' => 'media123', 'url' => 'http://snapadmin.net/image.jpg']);
        $slot->setFieldConfig($fieldConfig);
    ...
    public function testUrlWithLocal(): void
    {
        ...
        $manufacturer->setLink('http://snapadmin.net');
